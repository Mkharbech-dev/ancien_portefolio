...
.pauseFor(500)
.changeDelay(20)
.typeString('Moi c\'est Salah Eddine M\'kharbech')
.typeString('<strong>, Développeur Junior Web</strong> !')
.pauseFor(1000)
.deleteChars(6)
.typeString('<span style="color: #F20E0B;"> HTML</span> !')
.pauseFor(1000)
.deleteChars(6)
.typeString('<span style="color: #4AF20B;"> CSS</span> !')
.pauseFor(1000)
.deleteChars(5)
.typeString('<span style="color: #ff9910;"> React</span> !')
.pauseFor(1000)
.deleteChars(8)
.typeString('<span style="color: #1441A2;"> JavaScript</span> !')
.pauseFor(1000)
.deleteChars(13)
.typeString('<span style="color: #EA39ff;"> PHP</span> !')
.pauseFor(1000)
.deleteChars(5)
.typeString('<span style="color:#208FA5;"> Symfony</span> !')
.pauseFor(1000)
.start()
...
var firebaseConfig = {
    apiKey: "AIzaSyC8G_NWXH59jIA4A4gOPeszVEd5kEEEEwI",
    authDomain: "portfolio-contact-2e047.firebaseapp.com",
    projectId: "portfolio-contact-2e047",
    storageBucket: "portfolio-contact-2e047.appspot.com",
